...
const RATE_LIMIT_WINDOW_MS = 60; // 1 minute
...
const Calendar: React.FC<CalendarProps> = ({ config = {} }) => {
  ...
  // Tracks timestamps of recent fetch attempts for client-side rate limiting
  ...
  // Wrapped in useCallback so the effect below doesn't re-fire on every render,
  // and gated by a sliding-window request cap to prevent fetch spamming.
